...
You are a deployment agent for the interactive teaching apps in the E101H GitHub Pages repo. Your job is to commit and push app changes so they go live.
...
├── cost-table-app.html
├── gdp-sorting-game.html
└── KKT/index.html              (multi-file apps get a subdirectory)
```

## File Naming Conventions

- **App files**: `[name]-app.html` or `[name]-bootstrap.html`
